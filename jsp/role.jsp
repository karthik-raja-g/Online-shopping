<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/roleStyle.css">
    ...
    <body>
            ...
            <div class="main">
	            <div class = "border">
		            <div class = "inner-cutout"> 
			            <h1 class="knockout">ROLE MENU</h1>
		            </div>
	            </div>
            </div>
        ...
        <div id = "roleBox" class = "box">
            <form method = "post" action = "addRole">
                <p><input type = "text" placeholder="Role name"name = "name" required/></p>
        ...
        <div style="text-align: center">
            <form method = "get" action = "viewRoles">
                <br><button type="submit" class="btn btn-success">
                <span class="glyphicon glyphicon-eye-open"></span> View all roles</button>
            </form>
        </div>
    </body>
</html>
